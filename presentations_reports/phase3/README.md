...
2. API
    ...
    - 16 October: 72K xdd-covid-19 set documents processed via COSMOS, with updated data products:
        ...
        - COSMOS API (beta version) available: https://xdd.wisc.edu/sets/xdd-covid-19/api/v2_beta/search?query=death rate&type=Figure . ~12k documents to be merged in next week. NOTE: This is a different version of the COSMOS API, hence the `v2_beta` versioning.
