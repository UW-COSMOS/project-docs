...
2. API
    ...
    - 16 October: 72K xdd-covid-19 set documents processed via COSMOS, with updated data products:
        ...
        - 3 For the time being, configured as `covid_v2` set https://xdd.wisc.edu/sets/covid_v2/api/beta/search?query=death%20rate&type=Figure . ~12k documents to be merged in next week.
