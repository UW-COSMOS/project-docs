...
We have already initiated a collaboration with the TA2 EMMAA Team (PI Peter Sorger) from Harvard. The goal of this collaboration is for the EMMAA team to use the technology developed in xDD and COSMOS to obtain data for the TA2 EMMAA project.
...
#### <a id="ref1"></a> [1] 21st Century Science Overload [http://blog.cdnsciencepub.com/21st-century-science-overload/](http://blog.cdnsciencepub.com/21st-century-science-overload/)
#### <a id="ref2"></a> [2] COSMOS Image Tagger [https://github.com/UW-COSMOS/image-tagger](https://github.com/UW-COSMOS/image-tagger)
#### <a id="ref3"></a> [3] GeoDeepDive Project [https://geodeepdive.org](https://geodeepdive.org)
